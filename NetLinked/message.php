...
<a  id="create" href="createmessage.php">Create Message</a><a  id="re" href="receivemessage.php">New messages
(<?php
$received = mysql_query("SELECT * FROM messages WHERE recipient = '$member_id' AND status = 'unread'");
								$receiveda = mysql_numrows($received);

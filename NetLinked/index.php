...
<body>
<div class="mainr" >
<div class="lefttop1" > <div class="lefttopleft"><a href="img/slaulogo.jpg" rel="facebox"><img src="img/slaulogo.jpg" width="150" height="100"  style="margin:10px 0 10px 0;border:1px solid #ccc;padding:1px;position:absolute" /></a></div>
<form action="login.php" method="post">
  ...
  <div class="label">
      ...
      <div class="label2">
        ...
        <div class="password">&nbsp;&nbsp;<a style="color:#eee" href="forgetpass.php">Forgot Password?</a></div>
      </div>
    </div>
...
<div class="downleft">
  <div class="picture">
  <img src="img/logo2.jpg" width="500" height="300" style="margin:50px 0 0 -20px;box-shadow:0 5px 5px #ccc"/>
  </div>
  <div class="field">

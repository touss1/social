...
<?php
									...
									while($row = mysql_fetch_array($post)){
										...
										echo "<input type='hidden' value='".$row['message_id']."' name='cantseeme'/>
											...
											<div style='float:left;'><a href='deletemessage.php?message_id=".$row['message_id']."' style='text-decoration:none;'>Delete</a> | <a href='deletemessage.php?mark_message_id=".$row['message_id']."' style='text-decoration:none;'>Mark as read</a></div>

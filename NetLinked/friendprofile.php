...
while($row1 = mysql_fetch_array($result1))
  ...
  echo " Posted by:<font color=#1d3162> {$row1['FirstName']}"."&nbsp;{$row1["LastName"]}</font>";
	...
	echo'&nbsp;&nbsp;<a class="style" href="like.php?id='.$row["comment_id"].'&from=friendprofile&u='.$userid.'&owner='.$row['member_id'].'"><img width=20 height=20  src=img/like.png>Like('.$likes.')</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="commenting.php?id='.$row['comment_id'].'" class=style>comment('.$coms.')</a>&nbsp;&nbsp; '.$del." ";
